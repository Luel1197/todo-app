package com.study.todoapp.config;

import com.study.todoapp.jwt.JwtAuthenticationFilter;
import com.study.todoapp.jwt.JwtAuthorizationFilter;
import com.study.todoapp.jwt.JwtUtil;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authorizeHttpRequests) ->
            authorizeHttpRequests
                ...
                .requestMatchers("/login").permitAll() // /users/** 로 시작하는 요청 모두 접근 허가 (스웨거의 접근도 여기서 허용 가능) (ex 특정 권한이 있는 사용자만 접근 가능하게도 설정 가능)
